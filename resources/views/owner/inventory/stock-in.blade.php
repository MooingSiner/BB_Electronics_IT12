...
@section('content')
    ...
    <p class="text-sm text-slate-500 mb-6">{{ $item->name }} &middot; currently {{ $item->stock }} in stock</p>
    ...
    <form method="POST" action="{{ route('owner.inventory.stockin.store', $item->id) }}" class="max-w-md">
        @csrf
